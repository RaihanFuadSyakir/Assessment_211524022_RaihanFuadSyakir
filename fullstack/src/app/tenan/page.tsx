...
export default function TenanPage() {
    const [tenans, setTenans] = useState<Tenan[]>([]);
    ...
    return (
        <div className='flex flex-row'>
            <CreateTenan setListTenan={setTenans} listTenan={tenans} index={arrNum} isEdit={isEdit} setEdit={setEdit} />
                    ...
                    <Table sx={{ minWidth: 650 }} aria-label="simple table">
                        <TableHead>
                            <TableRow className='bg-gray-400 border-2'>
                                ...
                                <TableCell align="center">Nama Tenan</TableCell>
                                <TableCell align="center">Nomor HP</TableCell>
                                <TableCell align="center">Aksi</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {tenans.map((row, index) => (
                                <TableRow
                                    key={index}
                                ...
                                >
                                    ...
                                    <TableCell align="center">{row.NamaTenan}</TableCell>
                                    <TableCell align="center">{row.HP}</TableCell>
                                    <TableCell align="center" className='flex flex-col'>
                                        <DeleteTenan listTenan={tenans} index={index} setListTenan={setTenans} />
                                        <Button
                                            variant="outlined"
                                            startIcon={<EditIcon />}
